    ...
    public function add_product($data)
    {
        ...
        if ($pro_type == 'simple_product') {
            $pro_variance_data = [
                ...
                'weight' => (isset($data['weight'][0])) ? $data['weight'][0] : 0,
                'height' => (isset($data['height'][0])) ? $data['height'][0] : 0,
                'breadth' => (isset($data['breadth'][0])) ? $data['breadth'][0] : 0,
                'length' => (isset($data['length'][0])) ? $data['length'][0] : 0,
            ];

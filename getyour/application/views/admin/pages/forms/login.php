        ...
        <div class="card-body login-card-body">
            ...
            <form action="<?= base_url('auth/login') ?>" class='form-submit-event' method="post">
                ...
                <div class="input-group mb-3">
                    <input type="<?= $identity_column ?>" class="form-control" name="identity" placeholder="<?= ucfirst($identity_column)  ?>" value="<?= (ALLOW_MODIFICATION == 0) ? '9876543210' : '' ?>">
                ...
                <div class="input-group mb-3">
                    <input type="password" class="form-control" name="password" placeholder="Password" value="<?= (ALLOW_MODIFICATION == 0) ? '12345678' : '' ?>">
                    <div class="input-group-append">
                        <div class="input-group-text">

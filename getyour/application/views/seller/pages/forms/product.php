                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 mt-1">
                                        ...
                                        <input name='tags' class='col-md-12' id='tags' placeholder="Type in some tags for example AC, Cooler, Flagship Smartphones, Mobiles, Sport Shoes etc" value="<?= (isset($product_details[0]['tags']) && !empty($product_details[0]['tags'])) ? $product_details[0]['tags'] : "" ?>" />
                                    </div>
                                </div>

                                    ...
                                    <td>
                                        <form id="update_form">
                                            ...
                                            <?php } else { ?>
                                                <div class="row">
                                                    <div class="col-md-12 mb-2">
                                                        <lable class="badge badge-success">Select status and delivery boy which you want to update</lable>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <a href="javascript:void(0);" title="Bulk Update" data-seller_id="<?= $items[0]['seller_id'] ?>" class="btn btn-primary col-md-4 ml-3 update_status_admin_bulk">
                                                            Update
                                                        </a>
                                            ...
                                            for ($j = 0; $j < count($pickup_location); $j++) {
                                                ...
                                                foreach ($order_item_ids as $id) {
                                                    ...
                                                    if (strtolower($shiprocket_order['data']['status']) == 'READY TO SHIP' &&  $active_status != 'processed') {
                                                    ...
                                                    <div class="row m-2 ml-6">
                                                        ...
                                                        <div class="col-md-5">
                                                            <?php if (isset($order_tracking_data[0])) { ?>
                                                                ...
                                                                <?php } else { ?>
                                                                    <?php if (empty($order_tracking_data[0]['pickup_scheduled_date']) && ($shiprocket_order['data']['status_code'] != 4 || $shiprocket_order['data']['status'] != 'PICKUP SCHEDULED') && $shiprocket_order['data']['status'] != 'CANCELED') { ?>

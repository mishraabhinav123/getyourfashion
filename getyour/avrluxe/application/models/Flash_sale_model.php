...
class Flash_sale_model extends CI_Model
{
    ...
    public function get_flash_list()
    {
        ...
        foreach ($city_search_res as $row) {
            ...
            $operate = "";
            if ($row['status'] !== '0') {
                $operate = ' <a href="javascript:void(0)" class="edit_btn btn action-btn btn-primary btn-xs mr-1 mb-1" title="Edit" data-id="' . $row['id'] . '" data-url="admin/Flash_sale/"><i class="fa fa-pen"></i></a>';
            }
            ...
            if ($row['status'] == '1') {
                ...
                $tempRow['status'] = '<a class="badge badge-secondary text-white" >Upcoming</a>';
            } else {

...
*/
    ...
    public function __construct()
    {
        ...
        $this->load->library(['upload', 'jwt', 'ion_auth', 'form_validation', 'paypal_lib', 'shiprocket']);
    ...
    public function get_user_cart()
    {
        ...
        */
        ...
        if (!$this->form_validation->run()) {
            ...
            $product_availability = check_cart_products_delivarable($_POST['user_id'], $area_id[0]['area_id'], $zipcode);

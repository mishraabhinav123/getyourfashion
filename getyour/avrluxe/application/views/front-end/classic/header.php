                    ...
                    <?php if ($this->ion_auth->logged_in()) { ?>
                        <li class="nav-item dropdown active">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg">
                                ...
                                <a href="<?= base_url('my-account/delete_user') ?>"   class="dropdown-item delete_user"><i class="fa fa-trash-alt mr-2 text-primary link-color"></i><?= !empty($this->lang->line('Delete Account')) ? $this->lang->line('Delete Account') : 'Delete Account' ?></a>
                            ...
                            <div class="cd-morph-dropdown cd-dp">
                                ...
                                <nav class="main-nav">
                                    <ul>
                                        ...
                                        <li class="morph-text">
                                            <a href="<?= base_url('products/offers_and_flash_sale') ?>"><?= !empty($this->lang->line('offers_flashSale')) ? $this->lang->line('offers_flashSale') : 'Offers & Flash Sale' ?></a>
                                        </li>
                                        <li class="morph-text">

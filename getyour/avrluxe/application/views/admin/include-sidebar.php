...
$doctor_brown_for_admin_app = get_settings('admin_app_doctor_brown');
...
<aside class="main-sidebar elevation-2 sidebar-dark-indigo">
    ...
    <a href="<?= base_url('admin/home') ?>" class="brand-link">
        <img src="https://avrluxe.com/uploads/media/2023/Graphic1_page-0001.jpg" alt="<?= $settings['app_name']; ?>" title="<?= $settings['app_name']; ?>" class="brand-image">
            ...
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent nav-flat" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                <?php if (has_permissions('read', 'media')) { ?>
                    <li class="nav-item">
                        <a href="<?= base_url('admin/brand/') ?>" class="nav-link">
                            <i class="nav-icon fas fa-ad text-danger"></i>
                            <p>
                                Brands
                            </p>
                        </a>
                ...
                <?php if (has_permissions('read', 'flash_sale')) { ?>
                    <li class="nav-item">
                        <a href="<?= base_url('admin/flash_sale/') ?>" class="nav-link">
                ...
                <?php if (has_permissions('read', 'new_offer_images')) { ?>
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="<?= base_url('admin/offer_slider') ?>" class="nav-link">
                                    <i class="fas fa-image nav-icon"></i>
                                    <p>Offers Slider</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?= base_url('admin/offer-slider/section-order') ?>" class="nav-link">
                                    <i class="fa fa-bars nav-icon"></i>
                                    <p>Sections Order</p>
                                </a>
                            </li>
                ...
                <?php if (has_permissions('read', 'settings')) { ?>
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <?php if (isset($doctor_brown_for_app) && !empty($doctor_brown_for_app) || (isset($doctor_brown_for_admin_app) && !empty($doctor_brown_for_admin_app))) {
                            ?>
                                <li class="nav-item text-sm">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?= base_url('admin/invoice/inventory-report') ?>" class="nav-link">
                                <i class="fa fa-chart-line nav-icon"></i>

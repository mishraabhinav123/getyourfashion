                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-8">
                                        ...
                                        <label for="local_shipping " class="col-form-label local_shipping <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                        </label>
                                        <div class="row col mt-3 deliverable_type <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                            ...
                                            ?>
                                            <div class="col-md-6 col-sm-12 <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                        ...
                                        <div class="row col mt-3">
                                            ...
                                            <div class="col-md-3 col-xs-6 is_attachment_required <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">

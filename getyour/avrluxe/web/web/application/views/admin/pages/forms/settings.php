        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        <form class="form-horizontal form-submit-event" action="<?= base_url('admin/setting/update_system_settings') ?>" method="POST" id="system_setting_form" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <textarea type="text" class="form-control" id="address" placeholder="Address" name="address"><?= isset($settings['address']) ? output_escaping(str_replace('\r\n', '&#13;&#10;', $settings['address'])) : ""; ?></textarea>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="latitude">Latitude <span class='text-danger text-xs'>*</span></label>
                                        <input type="text" class="form-control" name="latitude" value="<?= (isset($settings['latitude'])) ? $settings['latitude'] : '' ?>" placeholder="Latitude" />
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="longitude">Longitude <span class='text-danger text-xs'>*</span></label>
                                        <input type="text" class="form-control" name="longitude" value="<?= (isset($settings['longitude'])) ? $settings['longitude'] : '' ?>" placeholder="Longitude" />
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    <label for="local_pickup"> Enable Local / Store Pickup ? </label>
                                    <?php if (isset($shiprocket_settings['local_shipping_method']) && $shiprocket_settings['local_shipping_method'] == 1) { ?>
                                        <div class="card-body">
                                            <input type="checkbox" name="local_pickup" <?= (isset($settings['local_pickup']) && $settings['local_pickup'] == '1') ? 'Checked' : ''  ?> data-bootstrap-switch data-off-color="danger" data-on-color="success">
                                        </div>
                                    <?php } else { ?>
                                        <div class="card-body">
                                            <input type="checkbox" name="local_pickup" data-bootstrap-switch data-off-color="danger" data-on-color="success" disabled>
                                        </div>
                                    <?php } ?>
                                </div>
                            </div>
                            ...
                            <span class="d-flex align-items-center ">
                                <h4>Upload Order Attachments &nbsp;</h4>
                            </span>
                            <hr>
                            <div class="row">
                                <div class="form-group col-md-2">
                                    <label for="allow_order_attachments"> Allow Upload Order Attachment? </label>
                                    <div class="card-body">
                                        <input type="checkbox" name="allow_order_attachments" <?= (isset($settings['allow_order_attachments']) && $settings['allow_order_attachments'] == '1') ? 'Checked' : ''  ?> data-bootstrap-switch data-off-color="danger" data-on-color="success">
                                    </div>
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="upload_limit"> Maximum upload limit </label>
                                    <input type="number" name="upload_limit" min="1" class="form-control" value="<?= (isset($settings['upload_limit']) && $settings['upload_limit'] != '') ? $settings['upload_limit'] : ''  ?>" max="10" placeholder="Maximum upload limit" />
                                </div>
                            </div>
                            <span class="d-flex align-items-center ">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    <label for="is_admin_app_under_maintenance"> Admin App</label>
                                    <div class="card-body pl-0">
                                        <input type="checkbox" name="is_admin_app_under_maintenance" <?= (isset($settings['is_admin_app_under_maintenance']) && $settings['is_admin_app_under_maintenance'] == '1') ? 'Checked' : ''  ?> data-bootstrap-switch data-off-color="danger" data-on-color="success">
                                    </div>
                                    <label for="message_for_admin_app"> Message for Admin App</label>
                                    <div class="card-body pl-0">
                                        <textarea type="text" class="form-control" id="message_for_admin_app" placeholder="Message for Admin App" name="message_for_admin_app"><?= isset($settings['message_for_admin_app']) ? output_escaping(str_replace('\r\n', '&#13;&#10;', $settings['message_for_admin_app'])) : ""; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group col-md-4">
                                    ...
                                    <label for="message_for_web"> Message for Web maintenance mode </label>
                                    <div class="card-body pl-0">
                                        <textarea type="text" class="form-control" id="message_for_web" placeholder="Message for Web maintenance mode" name="message_for_web"><?= isset($settings['message_for_web']) ? output_escaping(str_replace('\r\n', '&#13;&#10;', $settings['message_for_web'])) : ""; ?></textarea>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                    <div class="form-group col-md-2">
                                        <label for="is_offer_popup_on"> Offer popup? </label>
                                        <div class="card-body">
                                            <input type="checkbox" name="is_offer_popup_on" <?= (isset($settings['is_offer_popup_on']) && $settings['is_offer_popup_on'] == true) ? 'Checked' : ''  ?> data-bootstrap-switch data-off-color="danger" data-on-color="success">
                                        </div>
                                    </div>

                                    <div class="form-group col-md-2">
                                        <label for="offer_popup_method">Offer popup Method </label>
                                        <select name="offer_popup_method" class="form-control">
                                            <option value="">Select</option>
                            ...
                            <div class="row">
                                <div class="form-group col-md-8">
                                    ...
                                    <a class="btn btn-xs btn-primary text-white" data-toggle="modal" data-target="#howItWorksModal" title="How it works">How Promo Code Discount works?</a>
                                    <input type="text" class="form-control" name="app_name" value="<?= base_url('admin/cron_job/settle_cashback_discount') ?>" disabled />
                                </div>
                            </div>
                            <h4>Cron Job URL for Active and Deactive Flash Sale</h4>
                            <hr>
                            <div class="row">
                                <div class="form-group col-md-8">
                                    <label for="app_name">Add Flash Sale Active/Deactive URL <span class='text-danger text-xs'>*</span> <small>(Set this URL at your server cron job list for "every five minute")</small></label>
                                    <a class="btn btn-xs btn-primary text-white" data-toggle="modal" data-target="#howFlashSaleWorksModal" title="How it works">How Flash Sale works?</a>
                                    <input type="text" class="form-control" name="app_name" value="<?= base_url('admin/cron_job/fetch_active_flash_sale') ?>" disabled />
                                </div>
                            </div>
                    ...
                    <div class="modal fade" id="howFlashSaleWorksModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body ">
                                    <ol>
                                        <li>Cron job must be set on your server for flash sale to be work.</li>

                                        <li> Cron job will run after every five minutes . </li>

                                        <li> after set cron job it will automatically check the added flash sale if its active or deactive and change their status </li>

                                        <li> If Flash Sale doesn't works make sure cron job is set properly and it is working. If you don't know how to set cron job for once in a day please take help of server support or do search for it. </li>
                                    </ol>
                                </div>
                            </div>
                        </div>

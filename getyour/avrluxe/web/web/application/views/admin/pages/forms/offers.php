                        ...
                        <form class="form-horizontal form-submit-event" action="<?= base_url('admin/offer/add_offer'); ?>" method="POST" id="payment_setting_form" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select name="main_offer_type" required id="main_offer_type" class="mb-2 form-control type_event_trigger" required="">
                                    ...
                                    <select name="offer_type" id="offer_type" required class="form-control type_event_trigger" required="">
                                        <option value="">Select Type</option>
                                ...
                                <div class="col mb-2" id="active_popup_offer">

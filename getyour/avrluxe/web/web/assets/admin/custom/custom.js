          ...
          ;(n = function (e, t, a) {
            ...
            n.on('created', function (t) {
              ...
              return (
                ...
                n.elem('feBlend', { in: 'SourceGraphic', mode: 'multiply' }),
                a
                  .elem('linearGradient', {
                    id: e + '-gradient',
                    x1: 0,
...
function orders_query_params (p) {0
  return {
    start_date: $('#start_date').val(),
    end_date: $('#end_date').val(),
    order_status: $('#order_status').val(),
  ...
  setInterval(function () {
    $.ajax({
      ...
      success: function (result) {
        var html = ''
        html +=
          '<a href="" id="notification_count" data-toggle="dropdown" class="nav-link notification-toggle nav-link-lg"><i class="fas fa-bell"></i><span class="badge badge-danger navbar-badge order_notification">' +
...
$(document).ready(function () {
  ...
  tinymce.init({
    ...
    toolbar:
      'undo redo | image media | code fullscreen| formatpainter casechange blocks | bold italic forecolor backcolor | ' +
      'alignleft aligncenter alignright alignjustify | ' +

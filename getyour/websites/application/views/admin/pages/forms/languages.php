                        ...
                        <div class="card-body">
                            ...
                            <form class="form-horizontal" id="update-language-form" action="<?= base_url('admin/language/save'); ?>" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="wallet" class="control-checkbox">Newsletter</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="wallet" class="control-checkbox">Useful Links</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="wallet" class="control-checkbox">Subscribe</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="wallet" class="control-checkbox">Follow us</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="wallet" class="control-checkbox">Find Us</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="wallet" class="control-checkbox">Call Us</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="wallet" class="control-checkbox">Forgot Password</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="see_all" class="control-checkbox">Sort By</label>

    ...
    public function place_order($data)
    {
        ...
        if (!empty($product_variant)) {
            ...
            $overall_total = array(
             ...
             $fcm_admin_subject = (!empty($custom_notification)) ? $custom_notification[0]['title'] . ' ID #' . $last_order_id : 'New order placed ID #' . $last_order_id;
             $fcm_admin_msg = (!empty($custom_notification)) ? $custom_notification[0]['message'] .'<br>' . ' Appliaction Name : ' . $system_settings['app_name'] . '' : 'New order received for  ' . $system_settings['app_name'] . ' please process it.';

        ...
        if (!empty($data)) {
            ...
            if ($wallet_updated == true) {
                ...
                foreach ($user_ids as $user) {
                    ...
                    $customer_msg = (!empty($custom_notification)) ? 'Hello Dear ' . $user_res[0]['username'] . ' ' . $custom_notification[0]['message'] . '<br>' .' Appliaction Name : ' . $app_name . '' :  'Hello Dear ' . $user_res[0]['username'] . 'Discounted Amount Credited, which orders are delivered. Please take note of it! Regards' . $app_name . '';

        ...
        */
        ...
        if ($returnable_amount > 0) {
            $fcmMsg = array(
                ...
                'body' => (!empty($custom_notification)) ? $custom_notification[0]['message'].'<br>' . $currency . ' ' . $returnable_amount : $currency . ' ' . $returnable_amount,
                'type' => "wallet",
            );
            send_notification($fcmMsg, $fcm_ids);
            //update_details(['is_refund' => 1], ['order_item_id' => $order_item_id], 'transactions');

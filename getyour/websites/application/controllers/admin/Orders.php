                ...
                if (isset($user_res[0]) && !empty($user_res[0])) {
                    if (isset($current_delivery_boy[0]['delivery_boy_id']) && $current_delivery_boy[0]['delivery_boy_id'] == $_POST['deliver_by']) {
                        if ($_POST['status'] == 'received') {
                            ...
                            $type = ['type' => "customer_order_update"];
                        }
                        $custom_notification = fetch_details('custom_notifications', $type, '');
                        $customer_msg = (!empty($custom_notification)) ? 'Hello Dear ' . $user_res[0]['username'] . ' ' . $custom_notification[0]['message'] .'<br>'. ' ID #' . $_POST['orderid'] .' Appliaction Name : ' . $app_name . '' :  'Hello Dear ' . $user_res[0]['username'] . 'Order status updated to' . $_POST['val'] . ' for order ID #' . $_POST['orderid'] . ' assigned to you please take note of it! Thank you. Regards ' . $app_name . '';
                        $fcmMsg = array(
                        ...
                        $customer_msg = (!empty($custom_notification)) ? 'Hello Dear ' . $user_res[0]['username'] . ' ' . $custom_notification[0]['message'] .'<br>' . ' ID #' . $_POST['orderid'] . ' Appliaction Name : ' . $app_name . '' : 'Hello Dear ' . $user_res[0]['username'] . 'you have new order to be deliver order ID #' . $_POST['orderid'] . ' please take note of it! Thank you. Regards ' . $app_name . '';
                        $fcmMsg = array(
    ...
    public function update_order_status()
    {
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
                    ...
                    if (isset($user_res[0]) && !empty($user_res[0])) {
                        ...
                        if (!empty($current_delivery_boy[0]) && count($current_delivery_boy) > 1) {
                            for ($i = 0; $i < count($current_delivery_boys); $i++) {
                                $customer_msg = (!empty($custom_notification)) ? 'Hello Dear ' . $user_res[$i]['username'] . $custom_notification[0]['message']  .'<br>'. ' ID #' . $order_items[0]['order_id'] . ' Appliaction Name : ' . $app_name . '' :  'Hello Dear ' . $user_res[$i]['username'] . 'Order status updated to' . $_POST['status'] . ' for order ID #' . $order_items[0]['order_id'] . ' assigned to you please take note of it! Thank you. Regards ' . $app_name . '';
                                $fcmMsg = array(
                                    'title' => (!empty($custom_notification)) ? $custom_notification[0]['title'] : "Order status updated",
                                    'body' => $customer_msg,
                                    'type' => "order"
                            ...
                            if (isset($current_delivery_boys[0]['delivery_boy_id']) && $current_delivery_boys[0]['delivery_boy_id'] == $_POST['deliver_by']) {
                                ...
                                $custom_notification = fetch_details('custom_notifications', $type, '');
                                $customer_msg = (!empty($custom_notification)) ? 'Hello Dear ' . $user_res[0]['username'] . ' ' . $custom_notification[0]['message'] .'<br>' . ' ID #' . $order_items[0]['order_id'] . ' Appliaction Name : ' . $app_name . '' :  'Hello Dear ' . $user_res[0]['username'] . 'Order status updated to' . $_POST['status'] . ' for order ID #' . $order_items[0]['order_id'] . ' assigned to you please take note of it! Thank you. Regards ' . $app_name . '';
                                $fcmMsg = array(
                                    'title' => (!empty($custom_notification)) ? $custom_notification[0]['title'] : "Order status updated",
                                    'body' => $customer_msg,
                                    'type' => 'order',
                                ...
                                $custom_notification =  fetch_details('custom_notifications',  ['type' => "delivery_boy_order_deliver"], '');
                                $customer_msg = (!empty($custom_notification)) ? ' Hello Dear ' . $user_res[0]['username'] . ' ' . $custom_notification[0]['message'] .'<br>'. ' ID #' . $order_items[0]['order_id'] . ' Appliaction Name : ' .$app_name . '' : 'Hello Dear ' . $user_res[0]['username'] . 'you have new order to be deliver order ID #' . $order_items[0]['order_id'] . ' please take note of it! Thank you. Regards ' . $app_name . '';
                                $fcmMsg = array(
                                    'title' => (!empty($custom_notification)) ? $custom_notification[0]['title'] : "You have new order to deliver",
                                    'body' => $customer_msg,
                                    'type' => "order"
            ...
            if (!empty($order_items)) {
                ...
                $custom_notification = fetch_details('custom_notifications', $type, '');
                $customer_msg = (!empty($custom_notification)) ? 'Hello Dear ' . $user_res[0]['username'] . ' ' . $custom_notification[0]['message'] .'<br>'. ' ID #' .  $order_item_res[0]['id'] .  ' Appliaction Name : ' . $app_name . '' :  'Hello Dear ' . $user_res[0]['username'] . 'Order status updated to' . $_POST['val'] . ' for order ID #' .  $order_item_res[0]['id'] . ' assigned to you please take note of it! Thank you. Regards ' . $app_name . '';
                $fcm_ids = array();
                if (!empty($user_res[0]['fcm_id'])) {
                    $fcmMsg = array(
                        'title' => (!empty($custom_notification)) ? $custom_notification[0]['title'] : "Order status updated",
                ...
                if (!empty($seller_res[0]['fcm_id'])) {
                    $customer_msg = (!empty($custom_notification)) ? 'Hello Dear ' . $seller_res[0]['username'] . ' ' . $custom_notification[0]['message'] .'<br>'. ' ID #' . $order_item_res[0]['id'] . ' Appliaction Name : ' . $app_name . '' :  'Hello Dear ' . $seller_res[0]['username'] . 'Order status updated to' . $_POST['status'] . ' for your order ID #' . $order_item_res[0]['id'] . ' please take note of it! Regards ' . $app_name . '';
                    $fcmMsg = array(
                        'title' => (!empty($custom_notification)) ? $custom_notification[0]['title'] : "Order status updated",
                        'body' => $customer_msg,
                        'type' => "order"
        ...
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
            ...
            if (!$this->form_validation->run()) {
                ...
                if (update_details(['status' => $status], ['order_id' => $order_id], 'order_bank_transfer')) {
                    ...
                    $customer_msg = (!empty($custom_notification)) ? $custom_notification[0]['message'] .'<br>'. ' Status :' . $status . ' ID: ' . $order_id : 'Bank Transfer Receipt' . $status . ' for order ID: ' . $order_id;

        ...
        if (!$this->form_validation->run()) {
            ...
            if ($this->Order_model->add_bank_transfer_proof($data)) {
                ...
                if (!empty($fcm_ids)) {
                    ...
                    $customer_msg = (!empty($custom_notification)) ? $custom_notification[0]['message'] . '<br>' . ' ID #' . $order_id . ' Appliaction Name : ' . $app_name : "Hello Dear Admin you have new order bank transfer proof. Order ID #" . $order_id . ' please take note of it! Thank you. Regards ' . $app_name . '';
                    $fcmMsg = array(

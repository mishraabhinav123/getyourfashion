            ...
            $.each(result, function (a, b) {
                ...
                if ($('.variant_stock_status').is(':checked') && $('.variant-stock-level-type').val() == 'variable_level') {
                    html += '<div class="form-group row">' +
                        ...
                        '<input type="number" name="variant_price[]" class="col form-control price varaint-must-fill-field" min="1" step="0.01"></div>' +
        ...
        $.each(data, function (a, b) {
            ...
            if ($('.variant_stock_status').is(':checked') && $('.variant-stock-level-type').val() == 'variable_level') {
                ...
                html += '<div class="form-group row">' +
                    ...
                    '<input type="number" name="variant_price[]" class="col form-control price varaint-must-fill-field" value="' + b.price + '" min="1" step="0.01"></div>' +
    ...
    Swal.fire({
        ...
        if (result.value) {
            ...
            var html = ' <input type="hidden" name="reset_settings" value="1">' +
                ...
                '<div class="col-md-12"> <input type="number" name="simple_price" class="form-control stock-simple-mustfill-field price" min="0"></div></div>' +
